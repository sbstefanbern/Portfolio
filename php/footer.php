...
<div class="footer-social">
  <h3>SOCIAL MEDIA</h3>
  <a href="https://www.linkedin.com/in/stefan-bernkilde" target="_blank"><img src="<?php if($currentPage !== 'home'){echo '../';}?>media/icon-linkedin.svg" alt="LinkedIn icon"></a>
  <a href="https://www.instagram.com/bernkilde" target="_blank"><img src="<?php if($currentPage !== 'home'){echo '../';}?>media/icon-instagram.svg" alt="Instagram icon"></a>
</div>
<div class="footer-copy">
  <p>&copy; 2018 Stefan Bernkilde - All rights reserved.</p>
