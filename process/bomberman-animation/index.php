    ...
    <main>
      <section id="process-container">
        ...
        <div class="process-img">
          <img alt="Bomberman animation" src="../process-media/bomberman-animation.png">
        </div>
        <div class="process-content">
          <a href="../process-media/bomberman-animation/css-animation.html" target="_blank" class="btn process-btn">
            <div class="btn-container">
              <div class="btn-front">SE CSS-ANIMATION</div>
              <div class="btn-bottom">SE CSS-ANIMATION</div>
            </div>
          </a>
          ...
          <a href="../process-media/bomberman-animation-story-img.png" target="_blank" class="btn process-btn">
            <div class="btn-container">
              <div class="btn-front">SE STORYBOARD</div>
              <div class="btn-bottom">SE STORYBOARD</div>
            </div>
          </a>
          <div class="process-subtext">
          ...
          <a href="../process-media/bomberman-animation-code-img.png" target="_blank" class="btn process-btn">
            <div class="btn-container">
              <div class="btn-front">SE CSS-KODE</div>
              <div class="btn-bottom">SE CSS-KODE</div>
            </div>
          </a>
          <div class="process-subtext">
